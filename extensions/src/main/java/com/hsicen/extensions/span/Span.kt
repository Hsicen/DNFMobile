package com.hsicen.extensions.span
...
class Span internal constructor(private val ctx: Context) {
    ...
    fun quoteColor(
        @ColorInt color: Int,
        @IntRange(from = 1L) stripeWidth: Int = 2,
            ...
            get() = field ?: if (contentUri != null) {
                try {
                    ...
                    com.orhanobut.logger.Logger.e(
                        "sms",
                        "Failed to loaded content " + contentUri!!,
                        e
                    )
                }
                field
                ...
                try {
                    ...
                    Logger.e("Span", "Unable to find resource: $resourceId")
                }
                field
            }
